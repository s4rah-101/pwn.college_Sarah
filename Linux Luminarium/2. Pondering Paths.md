...
The challenge was to understand and learn the cwd command and how it works and how we change the current directory using '.'

### My solution 
**Flag:** `pwn.college{A4fgvNUjYJ3GICH7LwnxgHe7UYH.QXwUTN0wyN1QzNzEzW}`

By giving the command as 'cd /' I entered the '/' directory. Then when I typed './challenge/run' it showed Correct and mentioned that it is a relative path from the right directory. And hence I received my flag 
...
./challenge/run is a relative path, invoked from the right directory!
Here is your flag:
pwn.college{A4fgvNUjYJ3GICH7LwnxgHe7UYH.QXwUTN0wyN1QzNzEzW}
```

### New Learnings
I learnt how to navigate through directories and how to run commands in those directories. I leared the '.' and '..' commands that are the two implicit entries that can refer to a path.
...
## Explicit Relative Paths, from /
The challenge was to understand and learn how to run a program while being in the same directory as the program

### My solution 
**Flag:** `pwn.college{ck5OzS_Rr7GhGb3W40IIMT7i7vK.QXxUTN0wyN1QzNzEzW}`

By giving the command as 'cd /challenge' I entered the '/challenge' directory. Then when I typed './run' it showed Correct and mentioned that it is a relative path from the right directory. And hence I received my flag.
...
Here is your flag:
pwn.college{ck5OzS_Rr7GhGb3W40IIMT7i7vK.QXxUTN0wyN1QzNzEzW}
```

### New Learnings
Use case of ./ is so that if files that have the same name in the '/' directory are not confused with other local files. 
./ acts a run command.
